        ...
        <>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="absolute right-0 top-11 w-48 bg-white border border-slate-100 rounded-xl shadow-xl py-1.5 z-50">
          ...
          {mobileOpen && (
            <div className="absolute top-16 left-0 right-0 bg-white border-b border-slate-100 shadow-lg md:hidden animate-fade-in">
              <div className="flex flex-col p-4 gap-1">
                ...
                <button
                  onClick={handleLogout}
                  className="text-left px-4 py-3 text-sm font-medium text-rose-600 hover:bg-rose-50 rounded-xl transition"
                >
                  Logout
                </button>
              </div>
